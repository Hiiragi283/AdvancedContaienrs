...
/**
 * Thanks to SkyTheory!
 * Reference: https://github.com/SkyTheory/SkyTheoryLib/blob/1.12.2/java/skytheory/lib/capability/DataProvider.java
 */

class ACCapabilityProvider<T : Any>(
    private val capability: Capability<T>,
    private val instance: T,
    private val serializer: INBTSerializable<NBTTagCompound>
